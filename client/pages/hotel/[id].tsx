...
import { ImageGallery, HotelReview } from "../../components/hotel";
              ...
              <div>
                <div className="flex justify-between flex-wrap">
                  ...
                  <div className="text-secondary flex items-center gap-x-2.5">
                    ...
                    <div
                      className="items-center p-3 text-sm font-medium text-center text-white bg-primary rounded-lg float-right"
                    >
                    ...
                    {showModal ? (
                      <HotelReview id={id} hotel={hotel} setShowModal={setShowModal} />
                    ) : null}
                  </div>
                </div>
